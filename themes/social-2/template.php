...
<script type="text/javascript">
		jQuery('document').ready(function(){
			...
			jQuery('.fbmessage .foot .send').click(function(){
				...
				jQuery('.fbmessage .body').html('<img src="<?php echo $this->theme_url; ?>social-2/images/loading.gif" />');
				jQuery.ajax({
					url:"<?php $this->plugin_path.'inc/facebooksrc/postfb.php' ?>",
					type:'POST',
